...
<?php } ?>
    ...
    <div class='panel-footer'>
      <P>Komentar : </P><br>
<?php 
      foreach($komentar as $komentar_key){ 
?>    
      <p><img src="/Siamang/assets2/images/icon_komentar.png"style="max-height:20px "/> <?php echo $komentar_key->komentar;?></p><br>
      
<?php } ?>


       <form action="komentar/tambahKomentar?id_acara=<?php echo $acara_key->id_acara;?>" method="post" > 
        <input type="text" name="komentar" placeholder="Masukkan komentar" class="form-control" required autofocus><br>
